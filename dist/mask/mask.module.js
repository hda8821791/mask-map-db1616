...
exports.MaskModule = void 0;
const common_1 = require("@nestjs/common");
const mask_controller_1 = require("./mask.controller");
const mask_service_1 = require("./mask.service");
let MaskModule = class MaskModule {
};
MaskModule = __decorate([
    (0, common_1.Module)({
        controllers: [mask_controller_1.MaskController],
        providers: [mask_service_1.MaskService],
    })
], MaskModule);
